...
| 3 | **No LTspice detection or first-run guidance** — solve-time refusal now names the download; what remains is saying so up front, before the first analog question | analog needs the student's own LTspice. Silence here becomes a confusing failure at solve time |
